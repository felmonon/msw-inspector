...
Build output in `dist/` is not committed to this repository; it is generated by `npm run build` at publish time. The GitHub Action bundle is vendored into `felmonon/msw-inspector-action` at release time.
